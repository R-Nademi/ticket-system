...
class Ticket:
    ...
    def __init__(self, passenger_name, origin, destination, start_date_time, end_date_time, ticket_type, airline, ticket_no, price):
    ...
    def to_tuple(self):
        return (self.name, self.origin, self.destination, self.date, self.time, self.price)